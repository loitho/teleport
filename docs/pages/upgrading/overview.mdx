...
rollback all components to the exact version they were running prior to the upgrade in
reverse order of the upgrade sequence above until only the Auth instances are running
...
restored, proceed to downgrading the Auth instances to the exact version of Teleport
they were running prior to the upgrade attempt.
